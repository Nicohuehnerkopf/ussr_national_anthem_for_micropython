...
buzzer = PWM(machine.Pin(15, machine.Pin.OUT))
...
melody = [
  ...
  "C5", "B4", "A4", "G4", "C4", "G4", "A4", "B4", "C5"
]

noteDurations = [ 8, 4, 6, 16, 4, 8, 8, 
                  4, 6, 16, 4, 8, 8, 
                  4, 8, 8, 4, 8, 8, 4, 8, 8, 2,
                  4, 6, 16, 4, 8, 8, 
                  4, 6, 16, 4, 8, 8, 
...
def playsong():
    for thisNote in range(len(melody)):
        toneDuration = 2000 / noteDurations[thisNote]
        playtone(tones[melody[thisNote]], toneDuration)
        pauseDuration = toneDuration * 1.3
        time.sleep_ms(int(pauseDuration))
